...
class SumberdanaRanwalRequest extends FormRequest
{
    ...
    {
        $count = SumberdanaRanwal::withTrashed()->where('kode_sumberdana', $this->kode_sumberdana)->count();
        return SumberdanaRanwal::create([
    ...
    {
        $sumberdana = SumberdanaRanwal::find($this->id);
    ...
    {
        $sumberdana = SumberdanaRanwal::withTrashed()->find($this->id);
        $sumberdana->restore();
        return $sumberdana;
    }
}
