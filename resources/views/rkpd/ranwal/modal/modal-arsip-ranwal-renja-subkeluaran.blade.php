                    ...
                    @else
                        @foreach ($subkeldels as $subkeldel)
                            <tr>
                                ...
                                <td>{{ $subkeldel->pagu->uraianpendapatan->uraian }}</td>
                                <td>
                                    <form action="/rkpd/ranwal/opd/{{ $opd->id }}/subkegiatan/{{ $subkeldel->subkegiatan->id }}/subkeluaran/{{ $subkeldel->id }}/restore" method="post">
                                        @csrf
