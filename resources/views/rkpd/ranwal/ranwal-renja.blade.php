        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <span class="card-title text-uppercase">Ranwal Renja {{ $opd->nama_opd }} tahun {{ $opd->tahun }}</span>
                </div>
                <div class="card-body">
                    ...
                    @if (lockRkpd('ranwal', session()->get('tahun')))
                        <div class="row mb-4">
                            ...
                            <div class="col-7 text-end">
                                <button class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#arsipSubkegiatanRanwalRenjaModal"><i class="fa-regular fa-folder-open"></i> Arsip Sub Kegiatan</button>
