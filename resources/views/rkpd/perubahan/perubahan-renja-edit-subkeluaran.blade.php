                ...
                <form action="" method="post">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="target" value="{{ old('target') ? old('target') : $subkeluaran->menjadi_target }}" class="form-control" id="targetSubkelEdit" placeholder="Target" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label for="satuanSubkelEdit" class="form-label">Satuan</label>
                                            <input type="text" class="form-control" id="satuanSubkelEdit" value="{{ $subkegiatan->menjadi_satuan }}" placeholder="Satuan" disabled>
                                        </div>
                                    </div>
                                </div>
                                @error('target')
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="anggaran" value="{{ old('anggaran') ? (int) old('anggaran') : (int) $subkeluaran->menjadi_anggaran }}" class="form-control" id="anggaranSubkelEdit" placeholder="Rp. ">
                                    @error('anggaran')
                                        <small class="text-danger"><i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select name="sumberdana" class="form-select select2-single" id="sumberdanaSubkelEdit" data-placeholder="Pilih...">
                                        ...
                                        @foreach ($opd->paguperubahans as $sumberdana)
                                            <option value="{{ $sumberdana->id }}" {{ old('sumberdana') ? (old('sumberdana') == $sumberdana->id ? 'selected' : '') : ($subkeluaran->menjadi_sumberdana == $sumberdana->kode_unik_sumberdana ? 'selected' : '') }}>{{ $sumberdana->sumberdana->uraian }}</option>
                                        @endforeach
                                    </select>
                                    @error('sumberdana')
                                        <small class="text-danger"><i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}</small>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="lokasi" value="{{ old('lokasi') ? old('lokasi') : $subkeluaran->menjadi_lokasi }}" class="form-control" id="lokasiSubkelEdit" placeholder="Lokasi" autocomplete="off">
                                    @error('lokasi')
                                        <small class="text-danger"><i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="anggaran_maju" value="{{ old('anggaran_maju') ? (int) old('anggaran_maju') : (int) $subkeluaran->menjadi_anggaran_maju }}" class="form-control" id="anggaranMajuSubkelEdit" placeholder="Rp. ">
                                    @error('anggaran_maju')
                                        <small class="text-danger"><i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <a href="/perubahan/rkpd/opd/{{ $opd->id }}" class="btn btn-secondary col-5 mx-auto">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
