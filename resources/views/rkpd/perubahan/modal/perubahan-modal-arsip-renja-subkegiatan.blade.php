<!-- Modal -->
<div class="modal fade" id="arsipSubkegiatanPerubahanRenjaModal" tabindex="-1" aria-labelledby="arsipSubkegiatanPerubahanRenjaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="arsipSubkegiatanPerubahanRenjaModalLabel">Arsip Sub Kegiatan</h1>
                    ...
                    @else
                        @foreach ($subkegdels as $subkegdel)
                            <tr>
                                ...
                                <td>
                                    <form action="/perubahan/rkpd/opd/{{ $opd->id }}/subkegiatan/restore" method="post">
                                        @csrf
