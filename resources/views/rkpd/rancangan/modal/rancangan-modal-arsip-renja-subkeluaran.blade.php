<!-- Modal -->
<div class="modal fade" id="arsipSubkeluaranrancanganRenjaModal" tabindex="-1" aria-labelledby="arsipSubkeluaranrancanganRenjaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="arsipSubkeluaranrancanganRenjaModalLabel">Arsip Sub Keluaran</h1>
                    ...
                    @else
                        @foreach ($subkeldels as $subkeldel)
                            <tr>
                                ...
                                <td>
                                    <form action="/rancangan/rkpd/opd/{{ $opd->id }}/subkegiatan/{{ $subkeldel->subkegiatan->id }}/subkeluaran/{{ $subkeldel->id }}/restore" method="post">
                                        @csrf
