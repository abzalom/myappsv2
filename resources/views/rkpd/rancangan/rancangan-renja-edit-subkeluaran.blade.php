                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select name="sumberdana" class="form-select select2-single" id="sumberdanaSubkelEdit" data-placeholder="Pilih...">
                                        ...
                                        @foreach ($opd->pagurancangans as $sumberdana)
                                            <option value="{{ $sumberdana->id }}" {{ old('sumberdana') ? (old('sumberdana') == $sumberdana->id ? 'selected' : '') : ($subkeluaran->sumberdana == $sumberdana->kode_unik_sumberdana ? 'selected' : '') }}>{{ $sumberdana->sumberdana->uraian }}</option>
                                        @endforeach
                                    </select>
                                    @error('sumberdana')
                                        <small class="text-danger"><i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}</small>
