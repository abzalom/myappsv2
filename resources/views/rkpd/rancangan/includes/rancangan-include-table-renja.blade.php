                                        ...
                                        @can('input renja')
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                @if (!$subkegiatan->subkeluarans_count)
                                                    <form action="/rancangan/rkpd/opd/{{ $opd->id }}/subkegiatan/destroy" method="post">
                                                        @csrf
                                ...
                                @foreach ($subkegiatan->subkeluarans as $subkeluaran)
                                    <tr class="fst-italic" id="subkeltr">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                @can('input renja')
                                                    <a href="/rancangan/rkpd/opd/{{ $opd->id }}/subkegiatan/{{ $subkegiatan->id }}/subkeluaran/{{ $subkeluaran->id }}/edit" type="button" class="btn btn-sm btn-info"><i class="fa-solid fa-edit"></i></a>
                                                    <form action="/rancangan/rkpd/opd/{{ $opd->id }}/subkegiatan/{{ $subkegiatan->id }}/subkeluaran/{{ $subkeluaran->id }}/destroy" method="post">
                                                        @csrf
                                                        <input type="hidden" name="aksi" value="delete">
