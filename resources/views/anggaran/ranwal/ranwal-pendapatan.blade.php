<x-app-layout :apps="$apps">
                                                                ...
                                                                <td class="text-center" style="width: 5%">
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        ...
                                                                        @if (!$uraian->pagus->count())
                                                                            <form action="/ranwal/pendapatan/destroy" method="post">
                                                                                @csrf
    ...
    @include('anggaran.ranwal.modal.ranwal-modal-add-pendapatan')
    @include('anggaran.ranwal.modal.ranwal-modal-edit-pendapatan')
    @include('anggaran.ranwal.modal.ranwal-modal-arsip-pendapatan')
    @include('sccript')
    <script src="/asset/js/ranwal/pendapatan_ranwal.js"></script>
