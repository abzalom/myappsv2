<x-app-layout :apps="$apps">
                                                                ...
                                                                <td class="text-center" style="width: 5%">
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        ...
                                                                        @if (!$uraian->pagus->count())
                                                                            <form action="/rancangan/pendapatan/destroy" method="post">
                                                                                @csrf
    ...
    @include('anggaran.rancangan.modal.rancangan-modal-add-pendapatan')
    @include('anggaran.rancangan.modal.rancangan-modal-edit-pendapatan')
    @include('anggaran.rancangan.modal.rancangan-modal-arsip-pendapatan')
    @include('sccript')
    <script src="/asset/js/rancangan/pendapatan_rancangan.js"></script>
