<x-app-layout :apps="$apps">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <form action="/rancangan/pagu/upload" method="post" id="formUploadPagu" enctype="multipart/form-data">
                                @csrf
                    ...
                    <table class="table table-bordered table-hover table-striped datatables-pagu">
                        ...
                        <tbody class="align-middle">
                            @foreach ($opds as $opd)
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                ...
                                                <div style="width: 25%">
                                                    Total : Rp. {{ number_format($opd->pagurancangans_sum_jumlah, 2, ',', '.') }}
                                                </div>
                                ...
                                @endif
                                @foreach ($opd->pagurancangans as $pagu)
                                    <tr>
                                        <td>
                                            <div class="row">
                                                <div style="width: 65%">
                                                ...
                                                <div style="width: 25%">
                                                    Total : Rp. {{ number_format($opd->pagurancangans->sum('jumlah'), 2, ',', '.') }}
                                                </div>
                                                <div class="text-center" style="width: 10%">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        <button type="button" class="btn btn-sm btn-primary btn-add-pagu-opd" value="{{ $opd->kode_opd }}" data-bs-toggle="modal" data-bs-target="#addPaguOpdModal"><i class="fa-solid fa-plus-square fa-lg"></i></button>
                                        ...
                                        <td class="text-center" style="width: 10%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <form action="/rancangan/pagu/destroy" method="post">
                                                    @csrf
    ...
    <script src="/asset/js/rancangan/pagu_opd_rancangan.js"></script>
    @include('anggaran.rancangan.modal.rancangan-modal-add-pagu-opd')
    @include('anggaran.rancangan.modal.rancangan-modal-edit-pagu-opd')
    @include('anggaran.rancangan.modal.rancangan-modal-restore-pagu-opd')
    @include('sccript')
</x-app-layout>
