<!-- Modal -->
<div class="modal fade" id="arsipSumberDanaRanwalModal" tabindex="-1" aria-labelledby="arsipSumberDanaRanwalModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="arsipSumberDanaRanwalModalLabel">Arsip</h1>
                        ...
                        @foreach ($deletes as $delete)
                            <tr>
                                ...
                                <td style="width: 15%" class="text-center">
                                    <form action="/rancangan/sumberdana/restore" method="post">
                                        @csrf
