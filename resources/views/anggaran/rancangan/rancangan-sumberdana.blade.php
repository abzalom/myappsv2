<x-app-layout :apps="$apps">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-6 text-start">
                            <a href="/rancangan/sumberdana/form" class="btn btn-primary"><i class="fa-solid fa-plus-square"></i> Input Sumber Dana</a>
                        </div>
                        <div class="col-6 text-end">
                            ...
                            <a href="/rancangan/sumberdana/cetak" class="btn btn-info" target="_blank"><i class="fa-solid fa-print"></i> Cetak</a>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div style="width: 20%;text-align:end">
                                                    {{ number_format($sumberdana->rancangans_sum_jumlah, 2, ',', '.') }}
                                                </div>
    ...
    @include('anggaran.rancangan.modal.rancangan-modal-arsip-sumberdana')
