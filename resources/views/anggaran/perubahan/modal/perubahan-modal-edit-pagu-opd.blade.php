...
<div class="modal fade" id="editPaguOpdModal" tabindex="-1" aria-labelledby="editPaguOpdModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/perubahan/pagu/update" method="post">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" name="aksi" value="update">
                    <input type="hidden" name="idpagu" id="idPaguEdit">
                    <input type="hidden" name="idsumberdana" id="idSumberdanaEdit">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jumlah" class="form-control" id="jumlahPaguInputEdit" placeholder="Jumlah pagu">
                    </div>
                </div>
