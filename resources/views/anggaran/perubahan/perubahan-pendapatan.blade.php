<x-app-layout :apps="$apps">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <span class="card-title">Perubahan Pendapatan Tahun Anggaran {{ tahun() }}</span>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                                                                ...
                                                                <td class="text-center" style="width: 5%">
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        ...
                                                                        @if (!$uraian->pagus->count())
                                                                            <form action="/perubahan/pendapatan/destroy" method="post">
                                                                                @csrf
    ...
    @include('anggaran.perubahan.modal.perubahan-modal-add-pendapatan')
    @include('anggaran.perubahan.modal.perubahan-modal-edit-pendapatan')
    @include('anggaran.perubahan.modal.perubahan-modal-arsip-pendapatan')
    @include('sccript')
    <script src="/asset/js/perubahan/pendapatan_perubahan.js"></script>
